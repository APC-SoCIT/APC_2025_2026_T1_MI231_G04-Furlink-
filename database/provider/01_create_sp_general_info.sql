...
-- Depends on: database/auth/01_create_profiles.sql
...
CREATE TABLE IF NOT EXISTS public.sp_general_info (
    ...
    -- response_by / approved_at / rejection_reason stay nullable even though the
    -- source sheet marks them "Required" — they can't exist before a decision is made
...
-- Timestamp Trigger (reuses update_modified_column from database/auth/01_create_profiles.sql)
